...
def _profile_to_dict(info) -> Dict[str, Any]:
    return {
        ...
        "ui_meta": _profile_attr(info, "ui_meta", None) or {},
...
def _fallback_profile_dicts(profiles_mod) -> List[Dict[str, Any]]:
    ...
    if default_home.is_dir():
        ...
        profiles.append({
            ...
            "ui_meta": _safe(lambda: profiles_mod.read_profile_meta(default_home).get("ui_meta", {}), {}),
    ...
    if profiles_root.is_dir():
        ...
        for entry in entries:
            ...
            profiles.append({
                ...
                "ui_meta": _safe(lambda entry=entry_path: profiles_mod.read_profile_meta(entry).get("ui_meta", {}), {}),
                "distribution_name": None,
                "distribution_version": None,
                "distribution_source": None,
                "has_alias": False,
